...
<xsl:template match="/">
		<html>
			<head>
				...
				<xsl:value-of select="tei:teiHeader/tei:fileDesc/tei:titleStmt/tei:title"></xsl:value-of>
				<link href="progettogg.css" rel="stylesheet" type="text/css"/>
			</head>
				<body>
				<img id="background" src="Immagini/sfondocarta.jpeg"/>
				<header>
					<img id="tit_img" src="Immagini/saussure_a.jpeg"/>
				</header>
				<nav id="navbar">
					<ul>
						<li>
				...
				<div class="container-p15" id="Pag15">
					<div class="titolo">
						<h3>Pagina 15</h3>
						<img id="pagina15" src="Immagini/imm44.png"/>
					</div>
				...
				<div class="paginavuota" id="PagVuota">
					<div class="emptypage">
						<h3>Pagina vuota</h3>
						<img id="paginavuota" src="Immagini/imm45.png"/>
					</div>
					<div class="img-wrapper">
						<xsl:element name="img">
							<xsl:attribute name="src">
				...
				<div class="container-p16" id="Pag16">
					<div class="titolo">
						<h3>Pagina 16</h3>
						<img id="pagina16" src="Immagini/imm46.png"/>
					</div>
					<div class="img-wrapper">
						<xsl:element name="img">
							<xsl:attribute name="src">
	...
	<xsl:template match="tei:editionStmt">
					...
					<p>Progetto a cura di: Greta Casula e Greta Montera
